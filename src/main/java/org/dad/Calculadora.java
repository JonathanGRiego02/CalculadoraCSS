...
public class Calculadora {
	 ...
	 * @return Cadena de texto con el contenido de la pantalla de la calculadora.
	 */
	 ...
	 * @param operador Operación a realizar; usar una constante: IGUAL, SUMAR, RESTAR, MULTIPLICAR, DIVIDIR.
	 */
